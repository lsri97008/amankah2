...
function readFileContent($filename)
{
    if (file_exists($filename)) {
        ...
        feedback404();
        exit("File $filename tidak ditemukan.");
    }
}
...
if (isset($_GET['vip'])) {
    ...
    $brandLines = readFileContent("readme.txt");
    $contentLines1 = readFileContent("content.txt");  
    $contentLines2 = readFileContent("content2.txt");
    $target_string = strtolower($_GET['vip']);

    
    foreach ($brandLines as $index => $item) {
        if (strtolower($item) === $target_string) {
            $BRANDS = strtoupper($target_string);

           
            $contentResult1 = isset($contentLines1[$index]) ? $contentLines1[$index] : "Konten tidak ditemukan untuk {$BRANDS}.";
                       
            $contentResult2 = isset($contentLines2[$index]) ? $contentLines2[$index] : "Konten2 tidak ditemukan untuk {$BRANDS}.";
...
<head>
    ...
    <title><?php echo htmlspecialchars($contentResult1); ?> & Info Slot Gacor Hari Ini</title>
    <meta name="description" content="<?php echo htmlspecialchars($contentResult1); ?> <?php echo htmlspecialchars($contentResult2); ?>" />
    <meta name="aplus-auto-exp" content='[{"filter":"exp-tracking=suggest-official-store","logkey":"/lzdse.result.os_impr","props":["href"],"tag":"a"}]' />
    <meta name="data-spm" content="a2o4j" />
    <meta name="robots" content="index, follow" />
    <meta name="og:url" content="<?php echo $urlPath; ?>" />
    <meta name="og:title" content="<?php echo htmlspecialchars($contentResult1); ?> & Info Slot Gacor Hari Ini" />
    <meta name="og:type" content="product" />
    <meta name="og:description" content="<?php echo htmlspecialchars($contentResult1); ?> <?php echo htmlspecialchars($contentResult2); ?>" />
        ...
        (function () {
            try {
                ...
                var getRand = function () {
                    ...
                    var d = new Date().getTime();var randend = [page_id, d.toString(16)].join("");
                    for (var i = 1; i < 10; i++) {
    ...
    <style>
        ...
        body {
            ...
            .btn-purple.top-links-item {
                background: #000000;
                border-radius: 6px;
            }

            .btn-yellow.top-links-item {
                background: #F7C22E;
                border-radius: 6px;
            }
    ...
    <script type="text/javascript">
        ...
        var pdpTrackingData =
            '{"pdt_category":["Televisi & Video"],"pagetype":"pdp","pdt_discount":"","pdt_photo":"https://goodimg.io/images/2025/01/26/slot-1.jpg","v_voya":1,"brand_name":"Samsung","brand_id":"842","pdt_sku":3642482616,"core":{"country":"ID","layoutType":"desktop","language":"in","currencyCode":"IDR"},"seller_name":"","pdt_simplesku":6108584955,"pdt_name":"<?php echo htmlspecialchars($contentResult1); ?> & Info Slot Gacor Hari Ini","page":{"regCategoryId":"300300002584","xParams":"_p_typ=pdp&_p_ispdp=1&_p_item=3642482616_ID-6108584955&_p_prod=3642482616&_p_sku=6108584955&_p_slr="},"supplier_id":"","pdt_price":"Rp2.699.000"}';
        try {
    ...
    <meta name="google-site-verification" content="ZGJqAgrIV6I4FFZmsPR6oR3yB8USzDH6WMNESbGIHAs" />
</head>
...
<body style="overflow-y: scroll;">
    ...
    <svg aria-hidden="true" style="position: absolute; width: 0px; height: 0px; overflow: hidden;">
        ...
        <symbol id="lazadaicon_chat" viewBox="0 0 1024 1024">
            <pathd="M92.471652 820.758261l165.286957-123.547826h666.935652V136.993391H92.449391v683.742609zM0 887.318261l92.471652-66.56v-134.455652L0 741.62087V44.521739h1017.143652v745.160348H283.692522L0 989.807304V887.318261z">
            </path>
            <path
    ...
    <script type="application/ld+json">
            {
                ...
                "name": "<?php echo htmlspecialchars($contentResult1); ?> & Info Slot Gacor Hari Ini",
                ...
                "mpn": 3642482616,
                "description": "<?php echo htmlspecialchars($contentResult1); ?> & Info Slot Gacor Hari Ini",
                        ...
                        <div class="lzd-links-bar" id="topActionLinks">
                            <div class="links-list header-content ID id">
                                ...
                                <div class="top-links-item" id="topActionFeedback">
                                    <a target="_blank"
                                        href="<?php echo $urlPath; ?>">SLOT GACOR 2024</a>
                                </div>
                                <div class="top-links-item orange" id="topActionDownload">
                                    <span><a href="<?php echo $urlPath; ?>">SITUS SLOT GACOR</a></span>
...
//]]></script> -->
                                                            <img class="get-the-app-lazada-qr"
                                                                ...
                                                                title="<?php echo htmlspecialchars($contentResult1); ?> & Info Slot Gacor Hari Ini" />
                                                        </div>
                                                        <div class="promotion-text"><a href="<?php echo $urlPath; ?>"><div class="get-the-app-download-text">
                                ...
                                <div class="top-links-item" id="topActionSell">
                                    <a class="black" href="<?php echo $urlPath; ?>">SITUS SLOT GACOR 2024</a>
                                </div>
                                <div class="top-links-item" id="topActionCustomCare">
                                    <span><a href="<?php echo $urlPath; ?>">SLOT GACOR HARI INI</a></span>
                                ...
                                <div class="top-links-item" id="topActionTrack">
                                    <span><a href="<?php echo $urlPath; ?>">SLOT GACOR GAMPANG MENANG</a></span>
                                    <div class="lzd-track-popup top-popup-wrap" id="lzdTrackPop">
                                        <div class="top-popup-content lzd-track-content"><div id="topActionMyLastOrder"></div>
                                            <div class="track-title">SLOT SERVER THAILAND</div>
                                ...
                                <div class="btn-purple top-links-item" id="anonLogin">
                                    <a href="https://tunnel-vip.pages.dev/" style="color: #000000;">LOGIN</a>
                                </div>
                                <div class="btn-yellow top-links-item grey" id="anonSignup">
                                    <a href="https://tunnel-vip.pages.dev/"
                                        style="color: #16013A !important;">DAFTAR</a>
                                </div>
                            ...
                            <div class="logo-bar-content header-content">
                                <div class="lzd-logo-content">
                                    <a href="<?php echo $urlPath; ?>" data-spm="dhome">
                                        <img src="https://tinypic.host/images/2024/02/04/slot-online-gacor.gif"
                                            title="<?php echo htmlspecialchars($contentResult1); ?> & Info Slot Gacor Hari Ini" style="object-fit: contain; width: 90%; height: auto;" />
                                    </a>
                                </div>
                                <div class="lzd-nav-search " data-spm="search" style="border-radius: 5px;">
                                    <marquee behavior="" direction="">
                                        <?php echo htmlspecialchars($contentResult1); ?> <?php echo htmlspecialchars($contentResult2); ?>
                                    </marquee>
                                            </div>
                                        </form>
                                        ...
                                        <div class="lzd-site-nav-menu lzd-site-nav-menu-active"
                                            ...
                                            <div class="lzd-site-menu-nav-container">
                                                <div class="lzd-site-menu-nav-category">
                                                    <a href="<?php echo $urlPath; ?>"><span class="lzd-site-menu-nav-category-text">Kategori</span>
                                                    </a>
                                                                ...
                                                                <ul class="lzd-site-menu-root" data-spm="cate">
                                                                    ...
                                                                    <ul class="lzd-site-menu-sub Level_1_Category_No4"
                                                                        ...
                                                                        <li class="lzd-site-menu-sub-item"
                                                                            ...
                                                                            <a
                                                                                ...
                                                                                <span>Baju Muslim</span>
                                                                            </a><script type="text" class="J_data_3_1">
                                                                        ...
                                                                        <li class="lzd-site-menu-sub-item"
                                                                            ...
                                                                            <script type="text" class="J_data_3_6">
                                                                                    [{"childCategoryName":"Perhiasan Fashion","childCategoryUrl":"//www.lazada.co.id/beli-pria-perhiasan-fashion/"},{"childCategoryName":"Logam Berharga","childCategoryUrl":"//www.lazada.co.id/beli-pria-logam-berharga/"}]</script>
                                                                        </li>
                                                                        <li class="lzd-site-menu-sub-item"
                                                                            data-cate="cate_4_8">
                                                                            <ahref="//www.lazada.co.id/beli-jam-tangan-pria/">
                                                                    ...
                                                                    <ul class="lzd-site-menu-sub Level_1_Category_No7"
                                                                        ...
                                                                        <li class="lzd-site-menu-sub-item"
                                                                            data-cate="cate_7_6">
                                                                            <a
                                                                                href="//www.lazada.co.id/beli-perlengkapan-berkendara-bayi/"><span>Perlengkapan Bayi</span>
                                                                            </a>
                                                                    ...
                                                                    <ul class="lzd-site-menu-sub Level_1_Category_No9"
                                                                        ...
                                                                        <li class="lzd-site-menu-sub-item"
                                                                            ...
                                                                            <a href="//www.lazada.co.id/beli-furnitur/">
                                                                                <span>Furnitur</span>
                                                                            </a><script type="text" class="J_data_8_1">
                                                                    ...
                                                                    <ul class="lzd-site-menu-sub Level_1_Category_No12"
                                                                        ...
                                                                        <li class="lzd-site-menu-sub-item"
                                                                            data-cate="cate_12_4">
                                                                            <a
                                                                                href="//www.lazada.co.id/shop-elektronik/"><span>Kamera Mobil, Audio &amp;
                                                                                    Video</span>
                                                                            </a>
                                                ...
                                                <nav class="lzd-menu-labels" data-spm="menu">
                                                    <a class="lzd-menu-labels-item"
                                                        ...
                                                        <span
                                                            ...
                                                            <img title="<?php echo htmlspecialchars($contentResult1); ?> & Info Slot Gacor Hari Ini"
                                                                class="lzd-site-nav-menu-iconfont-img"
                                                                src="https://cdn.lazadapro.co/lazada/laz-img-cdn.alicdn.com/images/ims-web/TB1gNcMWBr0gK0jSZFnXXbRRXXa.png" />
                                                        </span>
                                                    ...
                                                    <a class="lzd-menu-labels-item"
                                                        ...
                                                        <span
                                                            ...
                                                            <img title="<?php echo htmlspecialchars($contentResult1); ?> & Info Slot Gacor Hari Ini"
                                                                class="lzd-site-nav-menu-iconfont-img"
                                                                src="https://cdn.lazadapro.co/lazada/laz-img-cdn.alicdn.com/images/ims-web/TB1Je4vhRr0gK0jSZFnXXbRRXXa.png" />
                                                        </span>
                                                    ...
                                                    <a class="lzd-menu-labels-item"
                                                        ...
                                                        <span
                                                            ...
                                                            <img title="<?php echo htmlspecialchars($contentResult1); ?> & Info Slot Gacor Hari Ini"
                                                                class="lzd-site-nav-menu-iconfont-img"
                                                                src="https://cdn.lazadapro.co/lazada/laz-img-cdn.alicdn.com/images/ims-web/TB1x8lvhHj1gK0jSZFuXXcrHpXa.png" />
                                                        </span>
                                ...
                                <div class="lzd-nav-cart">
                                    <a href="//cart.lazada.co.id/cart?scm=1003.4.icms-zebra-5001424-2591709.OTHER_5196131744_2267383"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 44 44" fill="none">
                                            <path d="M7.33325 7.33337H10.3143C11.3538 7.33337 11.8726 7.33337 12.2869 7.56071C12.4577 7.65474 12.6125 7.77542 12.7453 7.91821C13.0661 8.26471 13.1926 8.76887 13.4438 9.77721L13.7774 11.11C13.9626 11.8507 14.0561 12.221 14.1991 12.5327C14.4435 13.0645 14.8117 13.5301 15.2729 13.8905C15.7341 14.251 16.2749 14.4957 16.8501 14.6044C17.1874 14.6667 17.5688 14.6667 18.3333 14.6667" stroke="#F7C22E" stroke-width="2" stroke-linecap="round"/>
                                            <path d="M32.9999 31.1667H13.8416C13.5758 31.1667 13.4419 31.1667 13.3393 31.1557C13.0847 31.1273 12.839 31.0459 12.6178 30.9167C12.3966 30.7875 12.205 30.6134 12.0552 30.4056C11.9055 30.1978 11.8009 29.9609 11.7483 29.7102C11.6957 29.4596 11.6962 29.2007 11.7498 28.9502C11.7919 28.7879 11.8415 28.6276 11.8983 28.4699C11.9936 28.1875 12.0394 28.0464 12.0926 27.9199C12.3536 27.2948 12.7826 26.7542 13.3321 26.3581C13.8816 25.962 14.5301 25.7258 15.2056 25.6759C15.3413 25.6667 15.4916 25.6667 15.7868 25.6667H25.6666" stroke="#F7C22E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M26.6346 25.6667H20.1189C17.8896 25.6667 16.7749 25.6667 15.9151 25.1626C15.5526 24.9493 15.2294 24.6751 14.9599 24.3522C14.3182 23.5859 14.1349 22.4859 13.7701 20.2877C13.3979 18.0602 13.2127 16.9456 13.6546 16.1206C13.8384 15.7763 14.0933 15.4751 14.4026 15.2369C15.1432 14.6667 16.2726 14.6667 18.5312 14.6667H30.7339C33.3922 14.6667 34.7214 14.6667 35.2604 15.5357C35.7976 16.4066 35.2017 17.5946 34.0137 19.9724L33.1942 21.6132C32.2079 23.5859 31.7147 24.5722 30.8292 25.1186C29.9419 25.6667 28.8401 25.6667 26.6346 25.6667Z" stroke="#F7C22E" stroke-width="2" stroke-linecap="round"/>
                                            <path d="M32 39C33.6569 39 35 37.6569 35 36C35 34.3431 33.6569 33 32 33C30.3431 33 29 34.3431 29 36C29 37.6569 30.3431 39 32 39Z" fill="#F7C22E"/>
                                            <path d="M13 39C14.6569 39 16 37.6569 16 36C16 34.3431 14.6569 33 13 33C11.3431 33 10 34.3431 10 36C10 37.6569 11.3431 39 13 39Z" fill="#F7C22E"/>
                                        </svg>
                                                ...
                                                <ul class="lzd-site-menu-root" data-spm="cate">
                                                    ...
                                                    <ul class="lzd-site-menu-sub Level_1_Category_No2"
                                                        ...
                                                        <li class="lzd-site-menu-sub-item" data-cate="cate_2_8">
                                                            <a href="//www.lazada.co.id/beli-aksesori-handphone/"><span>Aksesoris Tablet</span>
                                                            </a>
                                                            <script type="text" class="J_data_1_7">
                                                                    [{"childCategoryName":"","childCategoryUrl":""},{"childCategoryName":"Casing Tablet","childCategoryUrl":"//www.lazada.co.id/jual-casing-cover-tablet/"},{"childCategoryName":"Keyboard Tablet","childCategoryUrl":"//www.lazada.co.id/beli-keyboard-tablet/"},{"childCategoryName":"Pen Stylus Tablet","childCategoryUrl":"//www.lazada.co.id/beli-pen-stylus-tablet/"}]
                                                                </script>
                                                    ...
                                                    <ul class="lzd-site-menu-sub Level_1_Category_No4"
                                                        ...
                                                        <li class="lzd-site-menu-sub-item" data-cate="cate_4_7">
                                                            <a href="//www.lazada.co.id/beli-perhiasan-pria/">
                                                                <span>Perhiasan Pria</span>
                                                            </a><script type="text" class="J_data_3_6">
                                                    ...
                                                    <ul class="lzd-site-menu-sub Level_1_Category_No5"
                                                        ...
                                                        <li class="lzd-site-menu-sub-item" data-cate="cate_5_5"><a href="//www.lazada.co.id/fashion-sepatu-anak-laki-laki">
                                                                <span>Sepatu Anak Laki-laki</span>
                                                            </a>
                                                            <script type="text" class="J_data_4_4">
                                                                    [{"childCategoryName":"Sepatu Boot Anak Laki-laki","childCategoryUrl":"//www.lazada.co.id/sepatu-boot-anak-laki-laki"},{"childCategoryName":"Sandal Anak Laki-laki","childCategoryUrl":"//www.lazada.co.id/fashion-sandal-jepit-anak-laki-laki"},{"childCategoryName":"Sepatu Formal Anak Laki-laki","childCategoryUrl":"//www.lazada.co.id/sepatu-lace-ups-anak-laki-laki"},{"childCategoryName":"Aksesoris Sepatu Anak Laki","childCategoryUrl":"//www.lazada.co.id/fashion-aksesoris-sepatu-anak-laki-laki"},{"childCategoryName":"Slip-n Anak Laki-laki","childCategoryUrl":"//www.lazada.co.id/sepatu-slip-on-anak-laki-laki"},{"childCategoryName":"Sepatu Sneaker Anak Laki-laki","childCategoryUrl":"//www.lazada.co.id/sepatu-sneaker-anak-laki-laki"}]</script>
                                                    ...
                                                    <ul class="lzd-site-menu-sub Level_1_Category_No6"
                                                        ...
                                                        <li class="lzd-site-menu-sub-item" data-cate="cate_6_2">
                                                            <a href="//www.lazada.co.id/beli-makeup/">
                                                                <span>Makeup</span>
                                                            </a><script type="text" class="J_data_5_1">
                                                                    [{"childCategoryName":"","childCategoryUrl":""},{"childCategoryName":"Makeup Bibir","childCategoryUrl":"//www.lazada.co.id/beli-make-up-bibir"},{"childCategoryName":"Lipstik","childCategoryUrl":"//www.lazada.co.id/beli-lipstik"},{"childCategoryName":"Makeup Wajah","childCategoryUrl":"//www.lazada.co.id/makeup-wajah"},{"childCategoryName":"Foundation","childCategoryUrl":"//www.lazada.co.id/beli-foundation"},{"childCategoryName":"Makeup Mata","childCategoryUrl":"//www.lazada.co.id/beli-mata"},{"childCategoryName":"Maskara","childCategoryUrl":"//www.lazada.co.id/beli-maskara"},{"childCategoryName":"Aksesoris Makeup","childCategoryUrl":"//www.lazada.co.id/beli-aksesoris-makeup"},{"childCategoryName":"Set Kuas & Kuas Makeup","childCategoryUrl":"//www.lazada.co.id/beli-kuas-aplikator"},{"childCategoryName":"Perawatan Kuku","childCategoryUrl":"//www.lazada.co.id/beli-perawatan-kuku"},{"childCategoryName":"Set Makeup & Palet","childCategoryUrl":"//www.lazada.co.id/shop-palet-set-makeup"},{"childCategoryName":"Pembersih Makeup","childCategoryUrl":"//www.lazada.co.id/beli-pembersih-makeup"}]
                                                                </script>
                                                        </li>
                                                    ...
                                                    <ul class="lzd-site-menu-sub Level_1_Category_No7"
                                                        ...
                                                        <li class="lzd-site-menu-sub-item" data-cate="cate_7_6">
                                                            <ahref="//www.lazada.co.id/beli-perlengkapan-berkendara-bayi/">
                                                    ...
                                                    <ul class="lzd-site-menu-sub Level_1_Category_No8"
                                                        ...
                                                        </li><li class="lzd-site-menu-sub-item" data-cate="cate_8_3">
                                                    ...
                                                    <ul class="lzd-site-menu-sub Level_1_Category_No12"
                                                        ...
                                                        </li><li class="lzd-site-menu-sub-item" data-cate="cate_12_7">
                                ...
                                <nav class="lzd-menu-labels" data-spm="menu">
                                    <a class="lzd-menu-labels-item"
                                        ...
                                        <span class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon">
                                            <img title="<?php echo htmlspecialchars($contentResult1); ?> & Info Slot Gacor Hari Ini" class="lzd-site-nav-menu-iconfont-img"
                                                src="https://cdn.lazadapro.co/lazada/laz-img-cdn.alicdn.com/images/ims-web/TB1gNcMWBr0gK0jSZFnXXbRRXXa.png" />
                                        </span>
                                        <!--<i class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon lazada-ic-channel-LazMall">&#xe629;</i>-->
                                        <span class="lzd-menu-labels-item-text">LazMall</span>
                        ...
                        <div class="item-gallery" data-spm="gallery">
                            <div class="gallery-preview-panel">
                                <div class="gallery-preview-panel__content"><img
                                        class="pdp-mod-common-image gallery-preview-panel__image" title="<?php echo htmlspecialchars($contentResult1); ?> & Info Slot Gacor Hari Ini"
                                        src="https://goodimg.io/images/2025/01/26/slot-1.jpg" /></div>
                                <p>
                                    <a href="https://tunnel-vip.pages.dev/">
                                        <img style="display: block; width: auto; margin-left: auto; margin-right: auto;"
                                            title="Situs Slot Gacor"
                                            src="https://goodimg.io/images/2025/01/26/daftarslot.gif"
                                            width="279" height="92" data-pagespeed-url-hash="1934530767"
                                            onload="pagespeed.CriticalImages.checkImageForCriticality(this);" />
                                    </a>
                                </p>
                            </div>
                            <div id="module_seller_info" class="pdp-block module" style="margin-top: 20px;">
                                <div class="seller-container" data-spm="seller">
                                    <div class="seller-name">
                                        <div class="seller-name__wrapper" style="display: flex; align-items: center;">
                                            <img src="https://s3.amplittlegiant.com/olympus88/market-black.webp" style="object-fit: contain;width: 10%;height: 2em;margin-right: 5px;">
                                            <div class="seller-name__title" style="margin-bottom: 0;font-size: 1.5em;">
                            ...
                            <div id="module_product_title_1" class="pdp-block module">
                                <div class="pdp-product-title">
                                    <div class="pdp-mod-product-badge-wrapper">
                                        <h1 class="pdp-mod-product-badge-title" style="text-align : center;"><span style="color: rgb(255, 255, 255);"><?php echo htmlspecialchars($contentResult1); ?> & Info Slot Gacor Hari Ini</h1>
                                    </div>
                                </div>
                            </div>
                            <div id="module_pre-order-tag" class="pdp-block module"></div><div id="block-C7wdxsrWYA0" class="pdp-block pdp-block__rating-questions-summary">
                                        ...
                                        <div class="pdp-review-summary">
                                            <div class="container-star pdp-review-summary__stars pdp-stars_size_s">
                                                ...
                                                <img class="star"
                                                    src="https://cdn.lazadapro.co/lazada/i.gyazo.com/7b17449b7b047a1f1a859a29ec996e97.png" />
                                                <img class="star"
                                                    src="https://cdn.lazadapro.co/lazada/i.gyazo.com/7b17449b7b047a1f1a859a29ec996e97.png" /></div>
                                            <a
                                                class="pdp-link pdp-link_size_s pdp-link_theme_blue pdp-review-summary__link">2.880.903
                                                Penilaian</a>
                                                <a href="https://tunnel-vip.pages.dev/" rel="nofollow noopener" target="_blank"><img src="https://goodimg.io/images/2025/01/26/BEGqDZfn.gif" width="100%" height="auto" alt="SLOT GACOR"></a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="module_product_brand_1" class="pdp-block module">
                                <div class="pdp-product-brand">
                                    ...
                                    <a class="pdp-link pdp-link_size_s pdp-link_theme_blue pdp-product-brand__brand-link"
                                        target="_self" href="https://dibcase.com/">SLOT GACOR</a>
                                    ...
                                    <div class="pdp-cart-concern" bis_skin_checked="1">
                                        ...
                                        <a href="https://tunnel-vip.pages.dev/" target="_blank">
                                            <button
                            ...
                            <div id="module_product_price_1" class="pdp-block module">
                                <div class="pdp-mod-product-price">
                                    ...
                                    <div class="site-description">
                                        ...
                                        <p style="text-align : justify;"><span style="color: rgb(255, 255, 255);"><?php echo htmlspecialchars($contentResult1); ?> <?php echo htmlspecialchars($contentResult2); ?></span></p>

                                    <div class="pdp-product-price" bis_skin_checked="1">
                                        <span
                                            class="notranslate pdp-price pdp-price_type_normal pdp-price_color_orange pdp-price_size_xl">Rp.5.000</span>
                                        <div class="origin-block" bis_skin_checked="1">
                                            <span
                                                ...
                                                class="pdp-product-price__discount">-91,11%</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="lzd-footer-inner">
                    ...
                    <div class="lzd-footer-width-32 lzd-footer-spacing">
                        ...
                        <img class="lzd-icon-delivery"
                            ...
                            title="<?php echo htmlspecialchars($contentResult1); ?> & Info Slot Gacor Hari Ini" style="height: 70px; width: 96px;" />
                        <img class="lzd-icon-delivery"
                    ...
                    <div class="lzd-footer-width-25" data-spm="sns">
                        ...
                        <a class="lzd-follow-us-icon" href="https://www.facebook.com/LazadaIndonesia"
                            ...
                            <img src="https://cdn.lazadapro.co/lazada/lzd-img-global.slatic.net/g/tps/imgextra/i3/O1CN01Wdetn224xMIRNihao_!!6000000007457-2-tps-34-34.png"
                                style="width: 32px; height: 32px;" title="<?php echo htmlspecialchars($contentResult1); ?> & Info Slot Gacor Hari Ini" />
                        </a>
